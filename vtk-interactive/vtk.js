...
const operatDom = document.getElementById('operat')
const interactorStyle = vtkInteractorStyleManipulator.newInstance();
const interator = fullScreenRenderer.getInteractor();
interator.bindEvents(operatDom)
...
function reassignManipulators(interactorStyle) {
    ...
    Object.keys(uiComponents).forEach((keyName) => {
        //返回值是vtkMouseCameraTrackballZoomManipulator 或者MouseCameraTrackballRotateManipulator
...
// camera.setWindowCenter([1, 1], [1, 1])
